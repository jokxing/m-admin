<template>
    <div>
        <van-nav-bar title="礼金记录" left-arrow @click-left="$router.go(-1)"/>
        ...
        <div class="main">
            ...
            <tableLocked :headData="tableHead" :bodyData="tableBody" :noDataText="'礼金记录'" :isTableLeft='false' @goSort="sortClick"></tableLocked>
...
<script>
    ...
    import { aagentBonusRecordApi } from '../../http/api';
    export default {
        data () {
            var myDate = new Date();
            return {
